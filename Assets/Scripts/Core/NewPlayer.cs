...
public class NewPlayer : PhysicsObject
{
	...
	public void PlayStepSound()
	{
		...
		audioSource.PlayOneShot(stepSound, Mathf.Abs(Input.GetAxis("Horizontal") / 1.15f));
	}

	public void PlayJumpSound()
	{
		audioSource.pitch = (Random.Range(1f, 1f));
		GameManager.Instance.audioSource.PlayOneShot(jumpSound, 0.2f);
	}
	...
	private void OnTriggerEnter2D(Collider2D other)
	{
		...
		{
			pauseMenu.GetComponent<PauseMenu>().RestartLevel();
		}
	}
}